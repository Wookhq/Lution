...
def InitSidebar():
    ...
    st.sidebar.page_link(
        "pages/marketplace.py", label=LANG["lution.tab.marketplace"], icon="🛒"
    )
    st.sidebar.page_link("pages/mods.py", label=LANG["lution.tab.mods"], icon="🧩")
    st.sidebar.page_link(
        "pages/appearance.py", label=LANG["lution.tab.appearance"], icon="🛠️"
    )
    ...
    st.sidebar.page_link(
        "pages/lutionsettings.py", label=LANG["lution.tab.lutionsettings"], icon="⚙️"
    )
    st.sidebar.page_link("pages/about.py", label=LANG["lution.tab.about"], icon="ℹ️")
    st.sidebar.page_link(
        "pages/contributors.py", label=LANG["lution.tab.contributors"], icon="❤️"
    )
