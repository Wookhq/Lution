...
class Api:
    ...
    class GitHub:
        ...
        LATEST_VERSION: str = (
            r"https://raw.githubusercontent.com/TheKliko/klikos-modding-tool/refs/heads/version-2.0.0/GitHub%20Files/version.json"
        )
        LATEST_RELEASE_INFO: str = (
            r"https://api.github.com/repos/TheKliko/klikos-modding-tool/releases/latest"
        )
        MOD_GENERATOR_CONFIG: str = (
            r"https://raw.githubusercontent.com/klikos-modloader/config/refs/heads/main/mod_generator.json"
        )
    ...
    class Roblox:
        ...
        class Activity:
            ...
            def universe_id(place_id: str) -> str:
                ...
                return (
                    rf"https://apis.roblox.com/universes/v1/places/{place_id}/universe"
                )
            ...
            @staticmethod
            def thumbnail(
                universe_id: str, size: str = "512x512", circular: bool = False
            ) -> str:
                """
                Returns the API endpoint to retrieve the thumbnail of the specified game.
