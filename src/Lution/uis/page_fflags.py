...
class PageFFlags(Adw.Bin):
    def __init__(self):
        ...
        builder = Gtk.Builder.new_from_file("uis/page_fflags.ui")
    ...
    def load_config(self):
        # Load the FFlags from the config
        self.rpc = self.cf.ReadSoberConfig("discord_rpc_enabled") or False
        self.fpslimit = self.cf.ReadFflagsConfig("DFIntTaskSchedulerTargetFps") or "60"
